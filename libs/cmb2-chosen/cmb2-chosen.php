...
add_action( 'cmb2_render_sfn_chosen', 'sfn_render_chosen', 10, 5 );
...
add_action( 'cmb2_render_sfn_chosen_multi', 'sfn_render_chosen_multi', 10, 5 );

function sfn_chosen_sanitize( $override_value, $value ){
	return $value;
} // sfn_chosen_sanitize
add_action( 'cmb2_sanitize_sfn_chosen', 'sfn_chosen_sanitize', 10, 2 );

function sfn_chosen_multi_sanitize( $override_value, $value ){
	return $value;
} // sfn_chosen_sanitize
add_action( 'cmb2_sanitize_sfn_chosen_multi', 'sfn_chosen_multi_sanitize', 10, 2 );
